...
class AnalyzeImage: NSObject {
    ...
    final let url = "https://westcentralus.api.cognitive.microsoft.com/vision/v1.0/analyze"
...
extension AnalyzeImage.AnalyzeImageObject {
    ...
    func getEmotions(_ completion: @escaping (_ response: [[String : AnyObject]]?) -> Void) {
        ...
        let path = "https://westcentralus.api.cognitive.microsoft.com/vision/v1.0/recognize"
